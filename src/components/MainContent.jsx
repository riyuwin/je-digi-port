    ...
    return (
        ...
        <div className="body_container min-h-screen font-sans relative overflow-hidden bg-[#0f172a]"> 
            ...
            <main className="max-w-7xl mx-auto py-12 px-0 space-y-9">
                ...
                {/* HERO SECTION */}
                <section id="home" className="main_container about_container grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-1 items-center py-12">
                    ...
                    <div className="main_container flex justify-center md:justify-center">
                        ...
                        src={profilePic}
                        alt="Profile"
                        className="w-58 h-58 sm:w-84 sm:h-84 md:w-82 md:h-82 rounded-full object-cover shadow-2xl border-4 border-white"
                        />
                    </div>
